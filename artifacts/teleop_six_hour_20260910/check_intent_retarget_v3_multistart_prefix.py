...
full=BASE/'intent_retarget_v3_multistart/pico'
prefix=BASE/'intent_retarget_v3_multistart_prefix_audit/pico'
...
report=dict(kind='retarget_v3_multistart_independent_prefix_causality_check',frames=count,source_clip='pico',
            includes_single_start_v3_failure_onset=True,all_pose_and_diagnostic_arrays_exact=all(checks.values()),
...
(BASE/'intent_retarget_v3_multistart_prefix_causality.json').write_text(json.dumps(report,indent=2,allow_nan=False))
