...
SNAPSHOT_DIR=ROOT/'artifacts/teleop_six_hour_20260910/mpc_math_witness_v2_sources'
...
def main():
    ...
    for path,digest in BOUND_SOURCE_HASHES.items():
    ...
    (base/'mpc_independent_math_audit_v2.json').write_text(json.dumps(result,indent=2))
