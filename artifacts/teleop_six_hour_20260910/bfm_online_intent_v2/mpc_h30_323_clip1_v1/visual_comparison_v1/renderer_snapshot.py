...
def main():
    ...
    def combined(i):
        ...
        draw.text((WIDTH+16,10),'H30 MPC: CLIPPED FEEDBACK REPLAY',font=f24,fill='#ffb65b')
        draw.text((WIDTH+16,47),'MuJoCo 3.2.3; offline plan; correction +/-0.1 rad',font=f20,fill='#c0ccd7')
        ...
        draw.text((16,TOP+HEIGHT+37),f'PARTIAL PROBE: first 3.000 s source only | root error {drift:.3f} m | leg RMSE {leg:.3f} rad',font=f20,fill='#ffb6a4')
    ...
    receipt=dict(kind='native323_H30_clipped_feedback_partial_replay_vs_original_native_requested_reference',inputs=input_hashes,
