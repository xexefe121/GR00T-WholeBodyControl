...
def main(args):
    ...
    paths += [args.repo/'artifacts/teleop_six_hour_20260910'/name for name in ('bfm_terminal_yaw4_goal.py','walk003_terminal_yaw4_derivation_receipt.json')]
    ...
    provenance=dict(kind='explicit_offline_recorded_MPC_targets_then_BFM_standing_hybrid',clip='walk003',
        ...
        BFM_identity=dict(unmodified_base_helper=seed.identity(),effective_terminal_yaw_gain=4.,goal_override_sha256=sha(args.repo/'artifacts/teleop_six_hour_20260910/bfm_terminal_yaw4_goal.py')),motion_override=request['motion_override'],
        ...
        BFM_position_gain=1.,BFM_yaw_gain=4.,BFM_goal_horizon=8,
