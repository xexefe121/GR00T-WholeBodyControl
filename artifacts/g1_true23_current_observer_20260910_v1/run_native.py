"""One full native23 trial with current observer assimilation before inference."""
...
from gear_sonic.utils.g1_true23_measured_history_benchmark import run_reference_diagnostic
...
from gear_sonic.utils.g1_true23_current_momentum_observer import (
    CurrentMomentumSourceModel as VirtualSourceModel,
    CurrentMomentumHistoryAdapter as VirtualSourceHistoryAdapter,
)
...
def main():
    ...
    evidence = dict(
        kind="native23_current_measurement_momentum_source_model_full_pico_v1",
        identity=identity,
        result=result,
        timeline=timeline,
