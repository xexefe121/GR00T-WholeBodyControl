"""Retain prior full regression set and add all three new focused modules."""
...
inputs = {
    str(path): file_sha256(path) for path in [*paths, prior, Path(__file__), OUTPUT / "integrity_report.json"]
}
