"""Retain all 551 checks and add precision and actual-input trace coverage."""
...
prior = HERE.parent / "standing_retention_ppo_20260906_v1/regression_report.json"
...
modules = previous["modules"] + [
    "test_g1_true23_training_precision",
    "test_train_g1_true23_ieee_standing_retention",
    "test_g1_true23_policy_input_trace",
]
