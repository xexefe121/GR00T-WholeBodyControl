"""Retain all 572 checks and add recorded temporal-boundary coverage."""
...
prior = HERE.parent / "ieee_motion_ppo_20260906_v2/regression_report.json"
...
modules = previous["modules"] + ["test_g1_true23_recorded_training_boundary"]
