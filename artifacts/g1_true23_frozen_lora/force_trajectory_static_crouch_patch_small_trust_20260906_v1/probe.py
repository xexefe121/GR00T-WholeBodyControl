...
def main():
    ...
    config = ForceRestorationConfig(maximum_iterations=32, root_trust_m=0.015 / 16, joint_trust_rad=0.12 / 16)
    ...
    result["kind"] = "g1_true23_stationary_crouch_small_trust_patch_diagnostic_v1"
