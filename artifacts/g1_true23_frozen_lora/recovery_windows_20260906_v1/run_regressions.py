"""Retain all 614 checks and add early-return identity/accounting coverage."""
...
prior = HERE.parent / "v14_native_ieee_20260906_v1/regression_report.json"
...
modules = previous["modules"] + ["test_g1_true23_recovery_window"]
