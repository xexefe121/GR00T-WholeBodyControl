"""Retain the 641 preceding checks and test the reset/noise changes."""
...
prior = HERE.parent / "recovery_windows_20260906_v1/regression_report.json"
...
modules = previous["modules"] + [
    "test_g1_true23_sensor_noise_scale", "test_g1_true23_reset_curriculum"
]
...
code = int(pytest.main(
    [*map(str, paths), "-q", f"--junitxml={HERE / 'regression.xml'}"],
