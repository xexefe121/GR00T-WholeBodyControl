...
REFINED = ARTIFACTS / "force_trajectory_20260906_v1"
ENVELOPE = ARTIFACTS / "force_trajectory_envelope_20260906_v1"
...
def main():
    ...
    assert refinement["kind"] == "g1_true23_complete_force_refinement_v1"
        ...
        contacts.append(
            {
                ...
                "iterations": [
                    {k: v for k, v in item.items() if k in ("iteration", "qp", "fraction")}
    ...
    result = {
        "kind": "g1_true23_force_refinement_comparison_v1",
        "clips": len(expected),
