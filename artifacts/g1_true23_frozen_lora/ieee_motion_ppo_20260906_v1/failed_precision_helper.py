    ...
    try:
        ...
        yield (
            dict(
                ...
                changed_from_inherited_backend_defaults=["allow_tf32"],
        ...
        # Only the four settings changed by MJLab are restored. An unrelated
        # caller's dtype/autocast/global determinism changes are not overwritten.
