...
run_dir="$run_root/original_sonic_happy_rehearsal_seed20260818_v1"
log_file="$run_root/original_sonic_happy_rehearsal_seed20260818_v1.train.log"
exit_file="$run_root/original_sonic_happy_rehearsal_seed20260818_v1.exit"
