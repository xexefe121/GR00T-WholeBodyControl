"""One full native23 trial of explicit internal source29 predictions."""
...
from gear_sonic.utils.g1_true23_virtual_source_model import MISSING_IL, VirtualSourceModel
...
def main():
    ...
    bind(__file__)
    bind(HERE / "PHYSICS_EXPERIMENT.md")
    ...
    evidence = dict(
        kind="native23_internal_source_model_full_pico_v1",
        identity=identity,
        result=result,
        timeline=timeline,
