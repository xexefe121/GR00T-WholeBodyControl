...
NEW=BASE.parent
RUN=NEW/'one_step_physical_student_evaluation_v1'
FIT=NEW/'one_step_physical_student_v1'
...
def paths():
    ...
    p=dict(nominal_trace=RUN/'nominal/trace.npz',nominal_report=RUN/'nominal/report.json',
        ...
        centers=GEN/'generation/centers.npz',probes=GEN/'generation/features.npy',
        ...
        final_export_review=NEW/'one_step_physical_final_fit_review_v1/review.json',
        root_fit_review=NEW/'physical_fit_evidence_independent_v1/report.json',
        ...
        runtime_source=SRC/'student_linear_runtime.py',driver=SRC/'evaluate_physical_response_student.py',
...
def freeze():
    ...
    assert sha(p['nominal_trace'])==report['trace_sha256']=='38428ae27055be7c2e771c5a23056c858f004ef38f260a0b45a57662d8d0aae3'
    ...
    write(BASE/'request.json',dict(kind='one_saved_final75000_outcome_audit',source_sha256=sha(__file__),
...
def audit():
    ...
    write(BASE/'report.json',dict(passed=True,request_sha256=sha(BASE/'request.json'),source_sha256=sha(__file__),
        ...
        training_envelope='All3057 nominal centers,140622 velocity probes and3054 valid physical endpoint features; coordinate ranges are descriptive, not a feasibility or stability gate.',
        comparison_limitation='Same-clock targets and saved Windows Torch head predictions belong to distinct expert trajectories after control250; comparisons are descriptive. The WSL first activation has its own exact witness. No expert counterfactual evaluated by this audit.',
