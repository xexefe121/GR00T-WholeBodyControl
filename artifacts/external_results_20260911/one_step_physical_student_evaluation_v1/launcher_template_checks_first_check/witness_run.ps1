...
$bindingPath = 'Y:\Temp\tmpjppjxz2q\witness_binding.json'
...
if (Test-Path -LiteralPath 'Y:\Temp\tmpjppjxz2q\head_witness') { throw 'Existing attempt output must be preserved.' }
$executionLock = [System.IO.File]::Open('Y:\Temp\tmpjppjxz2q\witness_process\execution.lock',[System.IO.FileMode]::CreateNew,[System.IO.FileAccess]::Write,[System.IO.FileShare]::None)
$executionLock.Close()
$arguments = @(
    '-d',
    'Ubuntu-22.04',
    ...
    'MKL_NUM_THREADS=1',
    'PYTHONPATH=/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/tmpjppjxz2q/source_snapshot_v1',
    '/mnt/e/codex_sonic_runtime/mjbatch323_20260910/venv/bin/python',
    '/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/tmpjppjxz2q/source_snapshot_v1/head_activation_witness.py'
)
...
$result = Get-Content -Raw -LiteralPath 'Y:\Temp\tmpjppjxz2q\head_witness\report.json' | ConvertFrom-Json
