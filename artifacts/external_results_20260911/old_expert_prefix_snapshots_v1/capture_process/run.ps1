...
$requestPath = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\old_expert_prefix_snapshots_v1\capture_request.json'
if ((Get-TaskHash $requestPath) -ne '931a37dbe59f290b39da1d6160323f116e84aa587f32eed9042d7b8e0a03179a') { throw 'Capture request changed.' }
...
$arguments = @(
    ...
    'MKL_NUM_THREADS=1',
    'PYTHONPATH=/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/old_expert_prefix_snapshots_v1/source_snapshot_v1',
    '/mnt/e/codex_sonic_runtime/mjbatch323_20260910/venv/bin/python',
    '/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/old_expert_prefix_snapshots_v1/source_snapshot_v1/capture_old_prefix.py'
)
...
$result = Get-Content -Raw -LiteralPath 'E:\codex-artifacts\sonic23_teleop_resume_20260911\old_expert_prefix_snapshots_v1\capture\report.json' | ConvertFrom-Json
