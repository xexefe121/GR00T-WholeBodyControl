...
if ($review.launch_receipt_subject.sha256 -ne $clearance.launch_receipt_sha256 -or $review.launch_receipt_subject.path -ne $receiptPath.Replace('\','/') -or $review.binding_subject.sha256 -ne $receipt.binding_sha256 -or $review.binding_subject.path -ne $receipt.binding_path) { throw 'Final review does not name this exact binding and launch.' }
