...
$folder = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_full_state_evaluation_v1\witness_process'
$bindingPath = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_full_state_evaluation_v1\witness_binding.json'
if ((Get-TaskHash $bindingPath) -ne 'ae4301060656ca27eba97b89a0140e2ef7506eacbad257fabea273b53a3f3cd3') { throw 'Final binding changed.' }
...
$arguments = @(
    ...
    '-B',
    '/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/direct_target_full_state_evaluation_v1/source_draft_v1/head_activation_witness.py'
)
$rawExit = $null
$rawError = $null
try {
