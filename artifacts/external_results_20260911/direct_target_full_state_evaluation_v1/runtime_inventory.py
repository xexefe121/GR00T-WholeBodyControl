...
PRIOR=NEW/'direct_target_fp64_export_evaluation_v2'
...
def main():
    ...
    for name,digest in current.items():add(SOURCE/name,'reviewed65000 runtime source',digest)
    ...
    result={'kind':'explicit_direct65000_fixed_runtime_inventory','preparation_only':True,'recursive_training_hashes':False,
