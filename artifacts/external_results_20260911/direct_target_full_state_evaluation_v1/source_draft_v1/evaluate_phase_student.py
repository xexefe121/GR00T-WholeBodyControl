"""One freshcanonical BFM250, learned1019, terminal300 and250 lifecycle."""
import json
...
def main():
    ...
    common_request=dict(kind=KIND,clip='walk003',motion_override=override,model_manifest=manifest,
        ...
        head_sha256=sha(BASE/'fit/student_head.onnx'),baseline250_trace_sha256=sha(BASE.parent/'original_bfm_entry250_v1/entry250/trace.npz'),
    ...
    (BASE/'pilot_outcome.json').write_text(json.dumps(dict(nominal=result,extension=extended,new_expert_query_launched=False,one_fixed_phase_only_fit=True,ordinary_final_global_step=65000),indent=2,allow_nan=False)+'\n')
