...
$folder = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_full_state_evaluation_v1\evaluation_process'
$bindingPath = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_full_state_evaluation_v1\evaluation_binding.json'
if ((Get-TaskHash $bindingPath) -ne '5f0e2a0d0baf35aa3e8f0c2c06a7dc42422078f274d1d04f5f720f6094f2bf53') { throw 'Final binding changed.' }
...
$arguments = @(
    ...
    'PYTHONPATH=/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/direct_target_full_state_evaluation_v1/source_draft_v1',
    '/mnt/e/codex_sonic_runtime/mjbatch323_20260910/venv/bin/python',
    '-B',
    '/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/direct_target_full_state_evaluation_v1/source_draft_v1/evaluate_direct_target_student.py'
)
$rawExit = $null
$rawError = $null
try {
...
& 'C:/Users/camer/AppData/Local/Programs/Python/Python310/python.exe' 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_full_state_evaluation_v1\diagnostic_verdict.py' --base 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_full_state_evaluation_v1' --mode 'evaluation' --raw-record (Join-Path $folder 'raw_exit.json') --output (Join-Path $folder 'diagnostic_verdict.json')
