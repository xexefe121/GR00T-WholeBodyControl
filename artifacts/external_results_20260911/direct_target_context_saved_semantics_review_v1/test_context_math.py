...
class ContextChecks(unittest.TestCase):
    ...
    def test_causal_release_identity(self):
        b=dict(context_condition='causal',architecture=[1323,256,256,23],ordinary_final_step=68000,
            release_kind='ordinary68000_matched_context_same_weight_fp64_export')
