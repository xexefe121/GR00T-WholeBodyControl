...
def main():
    ...
    parser.add_argument('--factory-config',type=Path,default=NEW/'onboard_factory_firmware_v1/decoded_configs/policies/mimic_test/fsm_mimic_test.yaml')
    ...
    if args.native_conditioned:options['factory_config']=args.factory_config
    ...
    try:
        ...
        if args.native_conditioned:
            import yaml
            factory=yaml.safe_load(args.factory_config.read_text())
    ...
    report = dict(actor=str(args.actor), clip=args.clip, standing_diagnostic=args.standing,
        native_factory_conditioned=args.native_conditioned,native_limit_brake=args.native_conditioned,
