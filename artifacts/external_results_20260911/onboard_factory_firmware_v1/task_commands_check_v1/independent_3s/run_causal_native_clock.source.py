...
def main():
    ...
    report = dict(actor=str(args.actor), clip=args.clip, standing_diagnostic=args.standing,
        ...
        locomotion_conditioned=args.locomotion_conditioned,task_commands=args.task_commands,native_limit_brake=factory_enabled,
        leg_target_filter_alpha=.9 if args.task_commands else args.target_filter_alpha,
