...
def main():
    ...
    if args.fault_standing_capture and not args.locomotion_conditioned:raise ValueError('Fault standing capture requires --locomotion-conditioned')
    ...
    if factory_enabled:
        ...
        if args.locomotion_conditioned:options['fault_standing_capture']=args.fault_standing_capture
    ...
    report = dict(actor=str(args.actor), clip=args.clip, standing_diagnostic=args.standing,
        ...
        leg_target_filter_alpha=args.target_filter_alpha,
