...
foreach($name in @('fit_process/start.json','fit_process/child.json','fit/blinded/progress.json','fit/causal/progress.json','fit/blinded/failure.json','fit/causal/failure.json','fit/paired_failure.json','fit/paired_report.json','fit_process/exit.json')){
