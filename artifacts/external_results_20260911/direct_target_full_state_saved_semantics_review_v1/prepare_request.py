...
def main():
    ...
    binding=read(RUN/'evaluation_binding.json');launch=RUN/'evaluation_process';clearance=read(launch/'launch_clearance.json')
    ...
    request=dict(kind='one_pure_saved_ordinary65000_runtime_semantics_and_fixed_maps',
        ...
        original_requested_controls=1569,conditional_continuous_hold_controls=250,
        fixed_map_scope='All actually issued learned controls only, same-clock frozen query250 maps and six preclip tangent groups; no replanned expert truth.')
