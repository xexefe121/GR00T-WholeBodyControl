...
def main():
    ...
    output_paths=[BASE/'request.json',BASE/'launch_receipt.json',BASE/'dispatch.json',BASE/'source_preparation.json',Path(__file__)]
    ...
    result=dict(completion_accounting_passed=True,evidence_audit_passed=positive,behavioral_qualification=False,
        completed_utc=datetime.now(timezone.utc).isoformat(),request_sha256=sha(BASE/'request.json'),report_sha256=sha(BASE/'results_v1/report.json'),
