...
INVENTORY_SHA='8b11bcdb646779089ab1118468b8753b06317619455e02e8896aaaceb97742a3'
VENV='E:/codex_sonic_runtime/mjbatch323_20260910/venv/'
HELPERS=('prepare_audit_stage.py','verify_completion.py','test_audit_stage.py','derive_helpers.py')
...
def main():
    ...
    REVIEW=local(request['paths']['audit_source_review']);REVIEW_SHA=request['source_review_sha256']
