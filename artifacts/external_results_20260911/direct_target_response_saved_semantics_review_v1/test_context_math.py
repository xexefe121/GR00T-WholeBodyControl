...
class ContextChecks(unittest.TestCase):
    ...
    def test_causal_release_identity(self):
        b=dict(context_condition='causal',architecture=[1323,256,256,23],ordinary_final_step=71000,
            release_kind='ordinary71000_warm_balanced_context_same_weight_fp64_export')
