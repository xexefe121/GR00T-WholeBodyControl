...
def main():
    ...
    write(a.output/'request.json',dict(controller='BFM startup; original81000 head at250; compiled state feedback251..1268; BFM terminal and hold',
        original_timing=True,terminal_position_feedback_gain=3.0,initial_root_world_x_velocity_offset_mps=.03,requested_main_controls=1569,conditional_hold_controls=250,
