...
$folder = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\independent_native_stepper_equivalence_v1\replay_process'
$arguments = @(
'-d',
'Ubuntu-22.04',
'--cd',
...
'MKL_NUM_THREADS=1',
'PYTHONPATH=/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/independent_native_stepper_equivalence_v1/source_draft_v1',
'/mnt/e/codex_sonic_runtime/mjbatch323_20260910/venv/bin/python',
'/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/independent_native_stepper_equivalence_v1/source_draft_v1/runner.py',
'--request',
'/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/independent_native_stepper_equivalence_v1/replay_request.json',
'--clearance',
'/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/independent_native_stepper_equivalence_v1/replay_process/launch_clearance.json'
)
$rawExit = $null
$rawError = $null
try {
