...
'--request',
'/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/independent_native_stepper_equivalence_v1/witness_request.json',
'--clearance',
'/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/independent_native_stepper_equivalence_v1/witness_process/launch_clearance.json'
)
$rawExit = $null
$rawError = $null
try {
