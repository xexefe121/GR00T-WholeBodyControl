...
def main():
    ...
    script='head_activation_witness.py' if mode=='witness' else 'evaluate_velocity_chord_student.py'
    ...
    write(launcher,guard+command+verdict+'exit 0\n')
    ...
    receipt=dict(kind='one_selected_final70000_'+mode,binding_sha256=sha(binding_path),exact_wsl_arguments=arguments,input_hashes=pins,
