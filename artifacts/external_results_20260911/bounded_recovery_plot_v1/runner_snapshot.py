...
with np.load(bundle / 'pico/native_original.npz') as a:
...
ax[1, 1].set(ylabel='Per-frame leg-joint RMSE (rad)', title='Leg tracking deteriorates in this segment')
...
output = NEW / 'bounded_recovery_plot_v1'
