...
$folder = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_causal_response_evaluation_v1\evaluation_process'
$bindingPath = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_causal_response_evaluation_v1\evaluation_binding.json'
if ((Get-TaskHash $bindingPath) -ne '99fcd398f1afd3a928905fc0c55fda24043f9e41202205636ecb52aff326911f') { throw 'Final binding changed.' }
...
$arguments = @(
    ...
    '-B',
    '/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/direct_target_causal_response_evaluation_v1/source_draft_v1/evaluate_direct_target_student.py'
)
$rawExit = $null
$rawError = $null
try {
...
& 'C:/Users/camer/AppData/Local/Programs/Python/Python310/python.exe' 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_causal_response_evaluation_v1\diagnostic_verdict.py' --base 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_causal_response_evaluation_v1' --mode 'evaluation' --raw-record (Join-Path $folder 'raw_exit.json') --output (Join-Path $folder 'diagnostic_verdict.json')
