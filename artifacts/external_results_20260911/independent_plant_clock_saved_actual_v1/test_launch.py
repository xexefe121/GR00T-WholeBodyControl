...
class LaunchTests(unittest.TestCase):
    def test_fixed_v3_source_command(self):
        text=render('a'*64)
        self.assertIn('source_audit_v3/audit_clock.py --request ',text)
        self.assertIn('/independent_plant_clock_saved_actual_v1/request.json --output ',text)
        self.assertIn('PYTHONPATH=/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/independent_plant_clock_saved_root_review_v1/source_audit_v3',text)
