...
$bindingPath = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_causal_width512_evaluation_v1\witness_binding.json'
if ((Get-TaskHash $bindingPath) -ne '0d3b89d4917c62a5dc889753f4c111371d7197233cd4425cfbc6c5a2b54ded04') { throw 'Final binding changed.' }
...
$arguments = @(
    ...
    '-B',
    '/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/direct_target_causal_width512_evaluation_v1/source_draft_v1/head_activation_witness.py'
)
$rawExit = $null
$rawError = $null
try {
