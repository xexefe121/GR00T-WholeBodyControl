...
def main():
    ...
    for name,digest in current.items():add(SOURCE/name,'reviewed81000 width512 context runtime source',digest)
    ...
    result={'kind':'explicit_width512_81000_fixed_runtime_inventory','preparation_only':True,'recursive_training_hashes':False,
