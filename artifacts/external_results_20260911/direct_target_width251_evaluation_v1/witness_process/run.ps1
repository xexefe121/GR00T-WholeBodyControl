...
$folder = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_width251_evaluation_v1\witness_process'
$bindingPath = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_width251_evaluation_v1\witness_binding.json'
if ((Get-TaskHash $bindingPath) -ne '7571cdada92eccd7c29d4ff95e3981437a2de4e89745fda9cadb3941dad4b48b') { throw 'Final binding changed.' }
...
$arguments = @(
    ...
    'PYTHONPATH=/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/direct_target_width251_evaluation_v1/source_draft_v1',
    '/mnt/e/codex_sonic_runtime/mjbatch323_20260910/venv/bin/python',
    '-B',
    '/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/direct_target_width251_evaluation_v1/source_draft_v1/head_activation_witness.py'
)
$rawExit = $null
$rawError = $null
try {
...
& 'C:/Users/camer/AppData/Local/Programs/Python/Python310/python.exe' 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_width251_evaluation_v1\diagnostic_verdict.py' --base 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_width251_evaluation_v1' --mode 'witness' --raw-record (Join-Path $folder 'raw_exit.json') --output (Join-Path $folder 'diagnostic_verdict.json')
