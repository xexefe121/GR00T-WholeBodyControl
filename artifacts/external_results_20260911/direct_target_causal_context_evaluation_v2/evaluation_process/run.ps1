...
$folder = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_causal_context_evaluation_v2\evaluation_process'
$bindingPath = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_causal_context_evaluation_v2\evaluation_binding.json'
if ((Get-TaskHash $bindingPath) -ne 'c4a2953b38484973a4730897e06c854cd04948ae471e14364c594f5474dc5e3b') { throw 'Final binding changed.' }
...
$arguments = @(
    ...
    'PYTHONPATH=/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/direct_target_causal_context_evaluation_v2/source_draft_v1',
    '/mnt/e/codex_sonic_runtime/mjbatch323_20260910/venv/bin/python',
    '-B',
    '/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/direct_target_causal_context_evaluation_v2/source_draft_v1/evaluate_direct_target_student.py'
)
$rawExit = $null
$rawError = $null
try {
...
& 'C:/Users/camer/AppData/Local/Programs/Python/Python310/python.exe' 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_causal_context_evaluation_v2\diagnostic_verdict.py' --base 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_causal_context_evaluation_v2' --mode 'evaluation' --raw-record (Join-Path $folder 'raw_exit.json') --output (Join-Path $folder 'diagnostic_verdict.json')
