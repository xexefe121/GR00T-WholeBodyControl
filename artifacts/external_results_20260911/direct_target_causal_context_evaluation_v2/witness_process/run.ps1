...
$folder = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_causal_context_evaluation_v2\witness_process'
$bindingPath = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_causal_context_evaluation_v2\witness_binding.json'
if ((Get-TaskHash $bindingPath) -ne '1502f0365a29c5ec8b21b2547f158a37d38999fb90260b34371e89a319e4006d') { throw 'Final binding changed.' }
...
$arguments = @(
    ...
    '-B',
    '/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/direct_target_causal_context_evaluation_v2/source_draft_v1/head_activation_witness.py'
)
$rawExit = $null
$rawError = $null
try {
