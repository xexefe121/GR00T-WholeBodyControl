...
def require_model_ready(base,purpose):
    ...
    assert binding['ordinary_final_step']==68000
    assert binding['controller']=='direct_absolute_target_1323_causal_context_study'
    assert binding['architecture']==[1323,256,256,23]
    assert binding['context_condition'] in ('blinded','causal')
