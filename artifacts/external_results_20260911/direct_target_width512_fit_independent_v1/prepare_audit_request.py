...
EXPERIMENT=BASE.parent/'direct_target_causal_width512_student_v1'
...
def main(args):
    ...
    assert report['ordinary_final_step']==81000 and report['optimizer_step']==16000 and report['hidden_width']==512
    ...
    result=dict(kind='saved_width512_warm_only',experiment=EXPERIMENT.as_posix(),python_path=PYTHON,
