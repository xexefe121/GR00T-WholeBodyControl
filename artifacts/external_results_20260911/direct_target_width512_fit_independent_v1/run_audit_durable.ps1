...
if($receipt.selected_single_saved_audit -ne $true -or $receipt.kind -ne 'saved_width512_warm_only' -or $receipt.request_sha256 -ne (Get-TaskSha (Join-Path $runRoot 'audit_request.json'))){throw 'Wrong selected saved audit.'}
