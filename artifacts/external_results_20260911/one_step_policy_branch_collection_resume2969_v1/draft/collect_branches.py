...
import numpy as np
from collection_arrays import Store,ROWS,HISTORY_WIDTHS,sha,atomic,replace_with_sharing_retry
...
def active_save():
    ...
    replace_with_sharing_retry(temp,DEST/'active.npz')
def progress():
...
def main():
    ...
    try:
        ...
        STORE=Store(DEST/'data',resume_directory=paths['prefix_data'])
