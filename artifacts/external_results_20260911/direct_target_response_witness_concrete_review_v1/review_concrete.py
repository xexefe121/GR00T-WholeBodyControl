"""Independent read-only review of the single causal71000 WSL witness package."""
...
result = dict(passed=True, reviewer='review_continuation', reviewed_utc=datetime.now(timezone.utc).isoformat(),
    ...
    context_condition='causal', ordinary_final_step=71000, features=1323, selected_single_run=True, mode='witness',
