...
from gear_sonic.utils.g1_true23_received_features import MeasuredHistory, features_numpy, prepare_reference
...
def main():
    ...
    default_copy=copy.deepcopy(old)
    hidden=[]
    ...
    with torch.no_grad():
        ...
        np.testing.assert_array_equal(old_output.numpy(),default_copy(inputs).numpy())
    hook.remove()
    ...
    motion=archive(ROOT/'artifacts/teleop_six_hour_20260910/mjbatch_native23_inputs_v1/walk003/native_original.npz')
