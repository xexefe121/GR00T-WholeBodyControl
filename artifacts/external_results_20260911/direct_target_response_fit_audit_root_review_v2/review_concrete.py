...
BASE=NEW/'direct_target_response_balanced_fit_independent_v2'
...
assert sha(BASE/'audit_request.json')=='e1e629307425a43b25d54c3c7ae7039c2c174bfd213e5171e5f71efa59a424de'
assert sha(BASE/'launch_receipt.json')=='7fce5b4880a201c916b9abfebf223e55245382b956594a6f2c28b738ddf759da'
...
assert len(launch['input_sha256'])==37
...
assert len(request['source_sha256'])==12
