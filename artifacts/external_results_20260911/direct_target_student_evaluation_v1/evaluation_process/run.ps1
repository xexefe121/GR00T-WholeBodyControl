...
$folder = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_student_evaluation_v1\evaluation_process'
$bindingPath = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_student_evaluation_v1\evaluation_binding.json'
if ((Get-TaskHash $bindingPath) -ne '5e2d5d38d09cfdac5b9c6cd437aa6ee465ff3b65b1d0dc9e1d85c99820d47ba1') { throw 'Final binding changed.' }
...
$arguments = @(
    ...
    '/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/direct_target_student_evaluation_v1/source_draft_v1/evaluate_direct_target_student.py'
)
$rawExit = $null
$rawError = $null
try {
