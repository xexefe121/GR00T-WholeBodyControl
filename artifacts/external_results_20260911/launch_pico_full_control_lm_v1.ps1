...
$wslArguments = @(
    ...
    '--output', '/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/pico_full_control_lm_v1'
)
& wsl.exe @wslArguments 1> (Join-Path $runBase 'pico_full_control_lm_v1.stdout.log') 2> (Join-Path $runBase 'pico_full_control_lm_v1.stderr.log')
exit $LASTEXITCODE
