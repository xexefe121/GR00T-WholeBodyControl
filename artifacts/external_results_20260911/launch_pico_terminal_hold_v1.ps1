...
$wslArguments = @(
    ...
    'env', 'PYTHONPATH=/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/pico_terminal_hold_source_v1/repo',
    'OPENBLAS_NUM_THREADS=1', 'OMP_NUM_THREADS=1', 'MKL_NUM_THREADS=1',
    '/mnt/e/codex_sonic_runtime/mjbatch323_20260910/venv/bin/python',
    '/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/pico_terminal_hold_source_v1/repo/gear_sonic/scripts/evaluate_g1_true23_mjbatch_mpc.py',
    '--bundle', 'artifacts/teleop_six_hour_20260910/mjbatch_native23_inputs_v1',
    '--clip', 'pico', '--probe', 'full-lifecycle', '--horizon', '30', '--iterations', '5',
    ...
    '--target-seed', 'artifacts/teleop_six_hour_20260910/bfm_pico_feedback_v2',
    ...
    '--checkpoint-controls', '50',
    '--preceding-run', '/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/pico_full_control_lm_v1',
    '--preceding-endpoint', '/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/pico_full_endpoint_independent_v1/endpoint.npz',
    '--output', '/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/pico_terminal_hold_v1'
)
& wsl.exe @wslArguments 1> (Join-Path $runBase 'pico_terminal_hold_v1.stdout.log') 2> (Join-Path $runBase 'pico_terminal_hold_v1.stderr.log')
exit $LASTEXITCODE
