...
class LaunchTests(unittest.TestCase):
    def test_fixed_retry_v2_source_command(self):
        ...
        self.assertIn('/independent_plant_pending_publication_saved_actual_v1/request.json --output ',text)
        self.assertIn('PYTHONPATH=/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/independent_plant_pending_publication_saved_audit_v1/source_draft_v2',text)
