...
def energy_weights(energy):
    assert tuple(energy['group_names'])==GROUPS and energy['rule']=='Emean/Eg'
...
def balanced_metrics(original,weights,energy):
    ...
    result['optimization_objective']='balanced_weighted_objective';result['response_weight_rule']='Emean/Eg'
    return result
