...
EXPERIMENT=BASE.parent/'direct_target_causal_response_balanced_student_v2'
...
def main(args):
    ...
    assert report['ordinary_final_step']==71000 and report['optimizer_step']==6000
    ...
    result=dict(kind='saved_response_balanced_warm_only',experiment=EXPERIMENT.as_posix(),python_path=PYTHON,
