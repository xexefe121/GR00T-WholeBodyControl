"""Frozen: exactly three current55000 FP32 forwards and three loss gradients.
...
def main():
    ...
    try:
        ...
        checkpoint = torch.load(request['subjects']['checkpoint']['path'], map_location='cpu', weights_only=True)
        ...
        expected_counts = dict(forward_attempted=3, forward_returned=3, forward_rows_attempted=14110, forward_rows_returned=14110, gradient_attempted=3, gradient_returned=3)
