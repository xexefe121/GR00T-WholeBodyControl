...
def main(args):
    ...
    request=read(request_path);assert request['kind']=='saved_width251_recovery_warm_only'
    ...
    receipt=dict(selected_single_saved_audit=True,kind='saved_width251_recovery_warm_only',request_sha256=args.request_sha256,
