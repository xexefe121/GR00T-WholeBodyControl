...
$folder = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\independent_plant_pending_publication_v1\clock_process'
$arguments = @(
'-d',
'Ubuntu-22.04',
'--cd',
...
'PYTHONPATH=/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/independent_plant_pending_publication_v1/source_draft_v1',
'/mnt/e/codex_sonic_runtime/mjbatch323_20260910/venv/bin/python',
'-B',
'/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/independent_plant_pending_publication_v1/source_draft_v1/run_clock.py',
'--request',
'/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/independent_plant_pending_publication_v1/clock_request.json',
'--clearance',
'/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/independent_plant_pending_publication_v1/clock_process/launch_clearance.json'
)
$rawExit = $null
$rawError = $null
try {
