...
PRIOR=NEW/'independent_plant_pending_publication_v1'
TIMEOUT=NEW/'independent_plant_clock_timeout_correction_v1'
SOURCE=BASE/'source_draft_v1'
AUDIT=NEW/'independent_plant_pending_result_saved_audit_v1'
...
SOURCE_PREP='88080d6c84025b7589a381a1d5d3dc5f170acdb69b20c95f31123f3c6278b4ad'
ROOT_REVIEW='b017dbb753fe2c8a0370288de01eb9e52275e2e5a365b54582da20cb15700640'
AUDIT_PREP='09bf03da9bae5285ccc24cabd77a83718e06485dbc267a50d047deceea1f3d91'
AUDIT_REVIEW='009d21d7dcc8b347da5d0f511ae2d2c24c22774eef84f8ba12f1e7101cb37a48'
CORE_SHA='76c54a589689411b1f4dd7c4937b9485f7979ec21065408c5cb51cfb67443626'
...
def check_review(prep,review,prep_path,prep_sha,expected_count,subject_field):
    ...
    check_subject(review.get(subject_field),prep_path,prep_sha)
...
def antecedent_paths(prep_path,review_path,audit_prep,audit_review,original_path,launch_path):
    return (prep_path,review_path,audit_prep,audit_review,original_path,launch_path,BASE/'helper_preparation.json',
        BASE/'source_changes.diff',BASE/'helper_derivation.json',BASE/'helper_derivation.diff',BASE/'PACKET_SCOPE.md',
...
def main():
    ...
    review_path=NEW/'independent_pending_result_source_review_v1/review.json'
    audit_prep=AUDIT/'source_preparation_v2.json'
    audit_review=NEW/'independent_pending_result_saved_audit_review_v1/review.json'
    ...
    check_review(aprep,read(audit_review),audit_prep,AUDIT_PREP,20,'preparation_subject')
    ...
    request.update(run_id='query250-recorded-clock-pending-result-BUSY-v1',input_epoch=3,source_directory=SOURCE.as_posix(),
