...
$valid='{"kind":"causal_response_balanced_continuation","root_selected":true,"updates":3000,"condition":"causal","fresh_optimizer":false,"ordinary_final_step":71000,"coefficient":1.8188207859141674}'
