...
from response_contract import check_protocol,COEFFICIENT
...
def gate(base,source):
    ...
    if (source_report['completed'] is not True or source_report['ordinary_final_step']!=68000
        or source_report['condition']!='causal' or source_report['optimizer_step']!=3000
        or source_report['checkpoint_sha256']!=request['subjects']['checkpoint']['sha256']):
        raise ValueError('Exact completed causal68000 fit required.')
