...
$folder = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_fp64_export_evaluation_v2\witness_process'
$bindingPath = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_fp64_export_evaluation_v2\witness_binding.json'
if ((Get-TaskHash $bindingPath) -ne '48ab01a8238008ab806f00a3c2328399960040452762cc16965d1baae8a67319') { throw 'Final binding changed.' }
...
& 'C:/Users/camer/AppData/Local/Programs/Python/Python310/python.exe' 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_fp64_export_evaluation_v2\diagnostic_verdict.py' --base 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_fp64_export_evaluation_v2' --mode 'witness' --raw-record (Join-Path $folder 'raw_exit.json') --output (Join-Path $folder 'diagnostic_verdict.json')
