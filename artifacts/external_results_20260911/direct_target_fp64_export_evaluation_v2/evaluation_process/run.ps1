...
$folder = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_fp64_export_evaluation_v2\evaluation_process'
$bindingPath = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_fp64_export_evaluation_v2\evaluation_binding.json'
if ((Get-TaskHash $bindingPath) -ne '7375bca43395397e7f730246a1ab707013133b20ff2e8297fc6be21c4f70f284') { throw 'Final binding changed.' }
...
$arguments = @(
    ...
    'MKL_NUM_THREADS=1',
    'PYTHONPATH=/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/direct_target_fp64_export_evaluation_v2/source_draft_v1',
    '/mnt/e/codex_sonic_runtime/mjbatch323_20260910/venv/bin/python',
    '/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/direct_target_fp64_export_evaluation_v2/source_draft_v1/evaluate_direct_target_student.py'
)
$rawExit = $null
$rawError = $null
try {
...
& 'C:/Users/camer/AppData/Local/Programs/Python/Python310/python.exe' 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_fp64_export_evaluation_v2\diagnostic_verdict.py' --base 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_fp64_export_evaluation_v2' --mode 'evaluation' --raw-record (Join-Path $folder 'raw_exit.json') --output (Join-Path $folder 'diagnostic_verdict.json')
