...
def require_model_ready(base,purpose):
    ...
    names=('head','checkpoint','fit_report','training_manifest','training_request','centers','query250_labels','contract','source_head','normalization','export_report','export_request','export_manifest')
