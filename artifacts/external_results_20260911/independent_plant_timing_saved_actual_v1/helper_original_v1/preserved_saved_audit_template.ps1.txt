...
if($receipt.selected_single_saved_audit -ne $true -or $receipt.request_sha256 -ne '8694708a3370fdd26e7f6f4dccb321a7c5afa1ba381a7f9df670511d953e6dcf'){throw 'Wrong selected saved audit.'}
...
try{
    ...
    $arguments='-d Ubuntu-22.04 --cd / -- bash /mnt/z/codex/GR00T-WholeBodyControl-sonic-transfer-23dof/artifacts/teleop_six_hour_20260910/RUN_PASSING_WALK_WSL.sh env OMP_NUM_THREADS=1 OPENBLAS_NUM_THREADS=1 MKL_NUM_THREADS=1 PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/direct_target_context_saved_semantics_review_v1 /mnt/e/codex_sonic_runtime/mjbatch323_20260910/venv/bin/python -B -u /mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/direct_target_context_saved_semantics_review_v1/audit_saved.py'
