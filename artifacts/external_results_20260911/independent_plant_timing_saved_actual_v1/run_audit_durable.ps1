...
if($receipt.selected_single_saved_audit -ne $true -or $receipt.request_sha256 -ne 'dd23d2ee96356e0381d384cd8839c8aaf72cada30f9ab6503ddf3b8233706a54'){throw 'Wrong selected saved audit.'}
...
try{
    ...
    $arguments='-d Ubuntu-22.04 --cd / -- bash /mnt/z/codex/GR00T-WholeBodyControl-sonic-transfer-23dof/artifacts/teleop_six_hour_20260910/RUN_PASSING_WALK_WSL.sh env OMP_NUM_THREADS=1 OPENBLAS_NUM_THREADS=1 MKL_NUM_THREADS=1 PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/independent_plant_timing_saved_audit_v1/source_draft_v2 /mnt/e/codex_sonic_runtime/mjbatch323_20260910/venv/bin/python -B -u /mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/independent_plant_timing_saved_audit_v1/source_draft_v2/audit_clock.py --request /mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/independent_plant_timing_saved_actual_v1/request.json --output /mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/independent_plant_timing_saved_actual_v1/results_v1'
