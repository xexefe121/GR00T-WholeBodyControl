...
def audit_graph(graph, checkpoint, normalization):
    ...
    for value, name, width in [(graph.graph.input[0], 'features', 1000),
    ...
    for key, checkpoint_key, norm_key in [('mean','feature_mean','feature_mean'), ('std','feature_std','feature_std')]:
        ...
        assert original.dtype == np.float32 and original.shape == (1000,)
    ...
    for layer, source_index, shape in zip(range(3), (0,2,4), [(256,1000),(256,256),(23,256)]):
