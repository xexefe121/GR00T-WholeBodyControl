...
FOLDER=BASE/'clock_process';OUT=BASE/'timeout_preservation_v2'
...
def main():
    ...
    assert len(mjb)==2
    start_utc=datetime.datetime.fromisoformat(start['utc'][:26]+'+00:00');raw_utc=datetime.datetime.fromisoformat(raw['utc'][:26]+'+00:00')
