...
try {
    ...
    & 'C:/Users/camer/AppData/Local/Programs/Python/Python310/python.exe' 'E:\codex-artifacts\sonic23_teleop_resume_20260911\independent_plant_process_clock_v1\stage_verdict.py' --base 'E:\codex-artifacts\sonic23_teleop_resume_20260911\independent_plant_process_clock_v1'
