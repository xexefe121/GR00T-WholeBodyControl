...
class ScaffoldTests(unittest.TestCase):
    ...
    def test_late_result_not_silently_admitted(self):
        ...
        worker_once(jobs,results,BINDING,commands,clock,FixedLedger(100));session.tick_once()
    ...
    def test_result_during_wait_exposes_conservative_poll_gap(self):
        ...
        def after_wait(deadline):
            if deadline==120_000_000:
                clock.ns=119_000_000;worker_once(jobs,results,BINDING,commands,clock,ledger);clock.ns=120_000_000
    ...
    def test_stub_worker_lifecycle_no_restart_and_join(self):
        ...
        ready=Event();ready.set();stop=Event();p=Process();life=WorkerLifecycle(p,ready,stop)
