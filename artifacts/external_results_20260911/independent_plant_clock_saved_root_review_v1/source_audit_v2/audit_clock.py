...
def run_audit(request,roles,proof):
    ...
    return dict(evidence_integrity_passed=True,physical_pass=physical_pass,timing_pass=timing_pass,command_pass=command_pass,
        ...
        initial=initial_result,physical=physical_result,counters=counter_result,timing=timing_result,controls=control_result,reserved_control=reserved_result,reserved_capture=reserved_capture,protocol=protocol_result,
