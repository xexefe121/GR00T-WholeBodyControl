...
def small_case():
    ...
    metadata['foundation_events']=[encoded(dict(physics=0,reason='JOB_PUBLICATION',activation=1,input_digest=identity['input_digest'],source_window=windows[1],status='PUBLISHED')),
