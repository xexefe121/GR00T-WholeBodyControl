...
def main():
    ...
    for name,digest in current.items():add(SOURCE/name,'reviewed68000 context runtime source',digest)
    ...
    result={'kind':'explicit_context68000_fixed_runtime_inventory','preparation_only':True,'recursive_training_hashes':False,
