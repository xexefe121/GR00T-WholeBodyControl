...
def main():
    ...
    binding=read(RUN/'evaluation_binding.json');assert binding['context_condition']=='causal' and binding['ordinary_final_step']==81000 and binding['architecture']==[1323,512,512,23]
    ...
    request=dict(kind='one_pure_saved_causal81000_width512_runtime_semantics_and_fixed_maps',
