...
def warm():
    return dict(condition='causal',features=1323,context_features=323,ordinary_start_step=71000,
        ordinary_final_step=81000,additional_updates=10000,optimizer_start_step=6000,optimizer_step=16000,
        architecture=[1323,512,512,23],hidden_width=512,expansion_seed=20260912,training_first_layer_execution='split_old256_new256_original1000_plus323',export_first_layer_execution='monolithic_float64_1323',fresh_optimizer=False,fixed_full_state_coefficient=1.8188207859141674,context_and_normalization_reused=True,
        response_weight_rule='mean_six_teacher_group_energies_over_group_energy',response_group_weights=[1.,2.,3.,4.,5.,6.],
        source_checkpoint_sha256='395aabf879c0a40b5187a4265ae850de49cfb62583e144145c1986d65402143d')
...
class ReleaseTests(unittest.TestCase):
    ...
    def test_common_only_constant_delta(self):
        old=NEW/'direct_target_response_saved_semantics_review_v1/saved_common.py'
