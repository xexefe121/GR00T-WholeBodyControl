...
def main():
    ...
    names = {'nominal_physics': 'expert_resumed_full_independent_physics_v1',
             'nominal_intent': 'expert_resumed_full_independent_intent_v1',
             'extension_physics': 'expert_resumed_hold_independent_physics_v1',
             'extension_intent': 'expert_resumed_hold_independent_intent_v1'}
    reports = {}
    ...
    output = BASE / 'expert_resumed_root_qualification_v1'
    ...
    decision = dict(root_authorized_extraction=True, model_fitting_authorized=False,
                    ...
                    scope='Collect and inspect expert labels controls1..1268 only; no fitting authorization',
