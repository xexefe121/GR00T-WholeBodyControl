...
r,l=read(rp),read(lp)
assert r['kind']=='one_pure_saved_causal81000_width512_runtime_semantics_and_fixed_maps'
...
assert sha(OUT/'review.json')==r['source_review_sha256']==l['source_review_sha256']=='0d92c33169dd39c787037239fa27dd80fb90a17196163510f2f095f8dbe20e4d'
...
assert stage['passed'] is True and stage['synthetic_tests_passed'] is True and stage['tests_run']==61
...
p=r['paths']
assert sha(p['owner'])==r['owner_sha256']=='0caad5d8a7574bfd0a082be64b1f17c8cfd0be38360ef28bad767adfe6b3552a'
assert sha(p['main_physics'])=='d20ba43f42227258a26b293edef6134cc7772391cbeac4cdfa87f5127d31da20'
assert sha(p['root_intent'])=='9d89c2456658a1df603a5b413786846a34a5f92fa140b82ebeda1d93db1e83af'
assert sha(p['main_trace'])=='b9061a1c9dc6aee65d713f16909a3135f072d94a5bc20af750b5958cc493629d'
...
assert physics['recorded_trace_reproduced_through_last_sample'] is True and physics['physics_steps']==3096
assert all(physics['original_trace_comparison'].values()) and physics['private_replay_steps_beyond_recorded_prefix']==0
assert intent['recorded_controls']==310 and intent['requested_controls']==1569
...
result=dict(passed=True,reviewer='root',reviewed_utc=datetime.now(timezone.utc).isoformat(),
 ...
 reviewed_semantics=['Exact causal81000 width512 request/source/helper maps and actual failure trace.',
 'Full1569 and conditional250 unchanged; completed root3096-step exact physical replay plus same-trace false intent verdicts.',
