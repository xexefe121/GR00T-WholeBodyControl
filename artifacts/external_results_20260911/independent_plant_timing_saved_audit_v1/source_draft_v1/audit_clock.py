...
def run_audit(request,roles,proof):
    ...
    if report['session'] is None:
        ...
        return dict(timing_sidecar=timing_sidecar,stage_watchdog=stage_result,stage_sources=stage_source,evidence_integrity_passed=True,physical_pass=False,timing_pass=False,command_pass=False,component_qualified=False,
