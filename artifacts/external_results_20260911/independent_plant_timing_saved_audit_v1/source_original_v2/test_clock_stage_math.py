...
def test_fixed_budget_and_original_timeout_coverage_reconstruction():
    request={'worker_result_retry_contract':'immutable_result_BUSY_max20_original_deadline','job_deadline_contract':'plant_epoch_plus_activation_20ms','job_publication_retry_contract':'pending_BUSY_same_job_max10_before_original_activation',
        'watchdog_budgets':dict(BUDGETS),'epoch_lead_ns':200000000,'debt_abort_steps':100,'elapsed_abort_ns':60*NS,
...
def test_actual_source_only_hashes_and_hot_loop_AST():
    ...
    paths={'original_runner':new/'independent_plant_process_clock_v1/source_runner_v1/run_clock.py',
        'clock_runner':new/'independent_plant_pending_result_v1/source_draft_v1/run_clock.py',
        'clock_watchdog':new/'independent_plant_clock_timeout_correction_v1/source_draft_v1/stage_watchdog.py',
        'clock_core':new/'independent_plant_pending_result_v1/source_draft_v1/clock_core.py',
        ...
        'original_core':new/'independent_plant_clock_timeout_correction_v1/source_draft_v1/clock_core.py'}
    result=source_contract(paths);assert result['fixed_outer_loop_AST_exact'] and result['producer_imports']==0
