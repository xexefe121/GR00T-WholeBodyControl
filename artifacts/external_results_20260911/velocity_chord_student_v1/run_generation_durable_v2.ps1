...
if((Read-Sha256 (Join-Path $runRoot 'generation_frozen_inputs_v2.json')) -ne $FrozenReceiptSha256){throw 'Frozen generation identity mismatch.'}
...
if((Read-Sha256 (Join-Path $runRoot 'run_generation_durable_v2.ps1')) -ne $clearance.launcher_sha256){throw 'Launcher identity mismatch.'}
