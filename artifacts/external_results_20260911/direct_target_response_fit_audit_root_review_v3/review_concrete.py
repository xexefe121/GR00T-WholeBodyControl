...
BASE=NEW/'direct_target_response_balanced_fit_independent_v3'
...
assert sha(BASE/'audit_request.json')=='7a09feb170fc2f0423d55ce471a82bc07d00f0e5fcce6853a1d428462879ffc4'
assert sha(BASE/'launch_receipt.json')=='0f5b558c6e08bf50923fe8ee03892108d9914ff79ddf6e9be99ed82de146e81e'
...
assert len(launch['input_sha256'])==38
...
assert len(request['source_sha256'])==13
