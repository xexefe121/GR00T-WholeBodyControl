...
def apply_control(s,trace,control,target,terminal=False):
    ...
    if not witness['feasible']:return dict(kind='imminent_control_infeasible',control=control,witness=witness,executed_rejected_controls=0)
    ...
    for sub in range(10):
        ...
        trace['physics_expected_time'].append(s['expected'])
