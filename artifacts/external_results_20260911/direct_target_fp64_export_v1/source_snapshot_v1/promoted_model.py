...
def from_checkpoint(saved):
    if saved['kind']!='direct_absolute_native23_target' or saved['ordinary_final_step']!=55000:raise ValueError('Exact ordinary55000 subject required')
...
def export_onnx(model,path):
    ...
    graph=helper.make_graph(nodes,'same_55000_weights_fp64_execution',[helper.make_tensor_value_info('features',TensorProto.FLOAT,[None,len(model.feature_mean)])],
