...
def main(args):
    ...
    camera.lookat[:] = [*center, args.camera_height]
    camera.distance, camera.azimuth, camera.elevation = args.camera_distance, 135, -18
...
if __name__ == '__main__':
    ...
    parser.add_argument('--camera-height', type=float, default=.42)
    parser.add_argument('--camera-distance', type=float, default=2.1)
