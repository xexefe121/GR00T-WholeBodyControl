...
def main():
    ...
    for name,digest in current.items():add(SOURCE/name,'reviewed91000 width512 recovery runtime source',digest)
    ...
    result={'kind':'explicit_width512_recovery91000_fixed_runtime_inventory','preparation_only':True,'recursive_training_hashes':False,
