...
$folder = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_width251_evaluation_v2\witness_process'
$bindingPath = 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_width251_evaluation_v2\witness_binding.json'
if ((Get-TaskHash $bindingPath) -ne '2a2614fb5a9a0193e16ee93e1b0d59ec59f68ad437247079ab61080cf6452fef') { throw 'Final binding changed.' }
...
$arguments = @(
    ...
    '-B',
    '/mnt/e/codex-artifacts/sonic23_teleop_resume_20260911/direct_target_width251_evaluation_v2/source_draft_v1/head_activation_witness.py'
)
$rawExit = $null
$rawError = $null
try {
...
& 'C:/Users/camer/AppData/Local/Programs/Python/Python310/python.exe' 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_width251_evaluation_v2\diagnostic_verdict.py' --base 'E:\codex-artifacts\sonic23_teleop_resume_20260911\direct_target_width251_evaluation_v2' --mode 'witness' --raw-record (Join-Path $folder 'raw_exit.json') --output (Join-Path $folder 'diagnostic_verdict.json')
