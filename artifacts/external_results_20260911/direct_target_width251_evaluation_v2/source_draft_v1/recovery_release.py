...
def recovery_request_identity(request):
    ...
    # Exact selected IEEE754 values; do not recompute libm cosine on another OS.
    import hashlib, struct
    assert hashlib.sha256(struct.pack('<10000d', *actual)).hexdigest() == '47c79db375e6c47234be296b635521ec6528224b165559d118ae7381fef3fa76', 'Different selected rate schedule'
