...
def report(condition):
    return dict(completed=True,optimization_completed=True,final_export_diagnostics_completed=True,
        ...
        max_preclip_error_rad=0.,counts=dict(training=counter(40000,157040000),
            diagnostics={k:counter(1441,368588) for k in ('initial_GPU32','final_GPU32','CPU64','GPU64','ORT64')},
...
@pytest.mark.parametrize('field,value',[
    ...
    ('architecture',[1323,256,256,23]),('hidden_width',256),('expansion_performed',True),('recovery_rows',1017),('recovery_phase_counts',[100,819,99]),('recovery_coefficient',1.0),('additional_updates',3000),
