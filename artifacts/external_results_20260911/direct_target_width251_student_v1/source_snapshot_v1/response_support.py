...
def gate(base,source):
    ...
    if (source_report['completed'] is not True or source_report['ordinary_final_step']!=71000
        or source_report['condition']!='causal' or source_report['optimizer_step']!=6000
        or source_report['checkpoint_sha256']!=request['subjects']['checkpoint']['sha256']):
        raise ValueError('Exact completed causal71000 fit required.')
