...
assert sha(rp)=='366c31139a99234d710037642b9f26124620ff6190501c41f293546a648c074e'
assert sha(fp)=='e1423363c6af8e6e88c04f3cfaf507d29416167b1bafe81d408ddcd5088dba13'
assert sha(lp)=='f5dc300610b242c6026163b652cd0304c585fc71a0e42502311510b49b5c744a'
assert sha(OUT/'review.json')=='935b27c9f93fa21f31552dd0707174076f490d26a18f00dfd28eb9eb3ff03280'
...
result=dict(prelaunch_review_pass=True,reviewer='root',reviewed_utc=datetime.now(timezone.utc).isoformat(),
 ...
 source_review_sha256=sha(OUT/'review.json'),source_sha256=f['source_sha256'],checked_input_pins=351,
