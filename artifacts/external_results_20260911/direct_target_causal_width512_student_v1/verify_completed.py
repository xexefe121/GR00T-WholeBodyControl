...
def validate_report(report):
    ...
    validate_counter(counts['training'],30000,146860000,complete)
    ...
    if complete:
        ...
        values=dict(condition='causal',ordinary_start_step=71000,ordinary_final_step=81000,additional_updates=10000,
            ...
            training_first_layer_execution='split_old256_new256_original1000_plus323',hidden_width=512,expansion_seed=20260912,architecture=[1323,512,512,23],export_first_layer_execution='monolithic_float64_1323')
