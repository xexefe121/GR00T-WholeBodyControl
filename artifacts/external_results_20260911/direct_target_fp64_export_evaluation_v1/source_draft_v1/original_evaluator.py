...
def main():
    ...
    (BASE/'pilot_outcome.json').write_text(json.dumps(dict(nominal=result,extension=extended,new_expert_query_launched=False,one_fixed_physical_response_fit=True,ordinary_final_global_step=75000),indent=2,allow_nan=False)+'\n')
