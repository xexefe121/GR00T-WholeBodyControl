...
def main(args):
    ...
    for p in [request_path,BASE/'run_audit_durable_v2.ps1',BASE/'prepare_audit_request_v2.py',BASE/'source_preparation_v2.json',BASE/'verify_completion_v2.py',Path(request['python_path']),Path(__file__)]:pins[p.resolve().as_posix()]=sha(p)
