...
def graph_fixture():
    ...
    actor={};arrays=[]
    for name,shape in [('0.weight',(256,1323)),('0.bias',(256,)),('2.weight',(256,256)),('2.bias',(256,)),('4.weight',(23,256)),('4.bias',(23,))]:actor[name]=torch.zeros(shape,dtype=torch.float32)
...
def test_audit_source_never_imports_or_calls_task_models():
    ...
    for file in ['audit_saved_pair.py','audit_context_math.py','audit_graph.py','audit_full_state_math.py','audit_math.py','audit_restoration.py']:
