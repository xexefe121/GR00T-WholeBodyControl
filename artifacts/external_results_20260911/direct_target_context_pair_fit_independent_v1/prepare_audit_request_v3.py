...
EXPERIMENT=BASE.parent/'direct_target_causal_context_study_v2'
...
def main(args):
    ...
    source=BASE/'source_draft_v3';sources={p.resolve().as_posix():sha(p) for p in sorted(source.glob('*.py'))}
