...
def main(args):
    ...
    source=BASE/'source_draft_v1';sources={p.resolve().as_posix():sha(p) for p in sorted(source.glob('*.py'))}
    ...
    owner_path=EXPERIMENT/'owner_completion_verification_v2.json'
