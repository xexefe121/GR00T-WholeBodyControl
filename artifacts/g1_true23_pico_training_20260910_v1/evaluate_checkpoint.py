...
def main():
    ...
    checkpoint = bind(args.checkpoint)
    ...
    if resolved.get("pico_used_for_training") is not True or policy.completed_updates not in (100, 500):
        raise ValueError("evaluation requires declared100/500 new-PICO milestone")
    ...
    for name, case in cases.items():
        ...
        adapter = NormalLoraAdapter(case["motion"], case["reference"].virtual_vr21, root=ROOT, assets=ASSETS)
