...
def main():
    ...
    if resolved.get("pico_used_for_training") is not True or policy.completed_updates not in (600, 1000):
        raise ValueError("evaluation requires declared600/1000 foot-precision milestone")
