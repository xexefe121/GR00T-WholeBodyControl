...
from gear_sonic.utils.g1_true23_step1b_mujoco import _quaternion_conjugate, _quaternion_matrix, _quaternion_multiply
...
def virtual_source_vr_terms(motion, source_model_path):
    ...
    result = []
    for index, q23 in enumerate(motion["joint_pos"]):
        data.qpos[:] = 0
