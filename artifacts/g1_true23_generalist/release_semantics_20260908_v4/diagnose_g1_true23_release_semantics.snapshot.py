...
def main(argv=None):
    ...
    with ieee_training_precision() as (precision, guard):
        ...
        for profile, mode, case in ((profile, mode, case) for profile in args.profiles for mode in args.modes for case in args.cases):
            guard()
            ...
            print(json.dumps(dict(
                mode=mode, profile=profile, case=case, completed=result["completed_controls"], available=result["available_controls"],
