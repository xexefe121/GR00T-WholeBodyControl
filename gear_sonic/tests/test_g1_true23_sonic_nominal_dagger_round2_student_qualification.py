...
from gear_sonic.scripts.qualify_g1_true23_sonic_nominal_dagger_round2_student import _parser
from gear_sonic.utils import (
    g1_true23_sonic_nominal_dagger_round2_bc_last_affine_ridge_v2 as fit,
    g1_true23_sonic_nominal_dagger_round2_student_qualification as adapter,
...
def test_real_adapter_preflight_ready_without_simulator() -> None:
    request = student.StudentQualificationRequest(
        ...
        output=Path("artifacts/g1_true23/unused_round2_student_test.json"),
        mode="initial510",
    )
    with adapter._adapter_scope(REPO_ROOT, 20260805):  # noqa: SLF001
