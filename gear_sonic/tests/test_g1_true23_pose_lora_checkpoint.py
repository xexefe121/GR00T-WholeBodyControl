...
from gear_sonic.scripts.train_g1_true23_pose_lora import validate_frozen_recipe
...
from gear_sonic.trl.mjlab.native23_pose_lora_runner import CHECKPOINT_HEADER
from gear_sonic.utils.g1_true23_original_intent_checkpoint import validate_semantics as old_reader
from gear_sonic.utils.g1_true23_pose_lora_checkpoint import PoseLoraCPUActor, validate_semantics
...
def test_old_reader_rejects_new_header_and_non_actor_cannot_infer():
    ...
    with pytest.raises(TypeError, match="distinct actor"):
        PoseLoraCPUActor(nn.Linear(2, 2))
