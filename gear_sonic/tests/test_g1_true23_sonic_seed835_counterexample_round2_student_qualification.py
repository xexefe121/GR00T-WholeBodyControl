...
def test_adapter_scope_binds_round2_candidate_and_restores() -> None:
    ...
    with adapter._adapter_scope(REPOSITORY_ROOT, 835868017):  # noqa: SLF001
        ...
        assert student.BC_MANIFEST_KIND.endswith("counterexample_round2_bc_last_affine_manifest_v1")
...
def test_candidate_hashes_match() -> None:
    ...
    decoder = manifest.with_name("sonic_seed835_counterexample_round2_bc_last_affine_v1.decoder.onnx")
