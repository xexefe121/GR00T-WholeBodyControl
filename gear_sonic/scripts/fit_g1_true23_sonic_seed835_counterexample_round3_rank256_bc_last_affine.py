"""Fit fixed-rank256 final-affine SONIC student on seed835 round3 data."""
...
from gear_sonic.utils.g1_true23_sonic_seed835_counterexample_round3_rank256_bc_last_affine import (
    preflight,
    run_fit,
)

DEFAULT_OUTPUT = Path("artifacts/g1_true23/sonic_seed835_counterexample_round3_rank256_bc_last_affine_v1")
