"""Fit versioned low-rank last-block SONIC adapter after strict v1 gate rejection."""
...
from gear_sonic.utils.g1_true23_sonic_nominal_dagger_lowrank_last_block_bc_v2 import (
    preflight,
    run_fit,
)
...
DEFAULT_OUTPUT = Path("artifacts/g1_true23/sonic_nominal_dagger_lowrank_last_block_bc_v2")
