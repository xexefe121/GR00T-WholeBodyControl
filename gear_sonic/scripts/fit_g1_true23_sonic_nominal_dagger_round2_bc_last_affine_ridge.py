"""Fit round2 final-affine SONIC student on nominal plus two intervention datasets."""
...
from gear_sonic.utils.g1_true23_sonic_nominal_dagger_round2_bc_last_affine_ridge import (
    preflight,
    run_fit,
)
...
DEFAULT_OUTPUT = Path("artifacts/g1_true23/sonic_nominal_dagger_round2_bc_last_affine_ridge_v1")
