"""Fit targeted round3 final-affine SONIC student on heldout teacher-reset rows."""
...
from gear_sonic.utils.g1_true23_sonic_nominal_dagger_multiseed_round3_bc_last_affine_ridge import (
    preflight,
    run_fit,
)
from gear_sonic.utils.g1_true23_sonic_nominal_multiseed_bc_last_affine_ridge import FitRequest, publish

DEFAULT_OUTPUT = Path("artifacts/g1_true23/sonic_nominal_dagger_multiseed_round3_bc_last_affine_ridge_v1")
        ...
        json.dumps(
            {
                ...
                "seed835_base_rmse": body["metrics"]["seed835"]["base"]["rmse"],
                "seed835_candidate_rmse": body["metrics"]["seed835"]["candidate"]["rmse"],
            },
            indent=2,
            sort_keys=True,
        )
