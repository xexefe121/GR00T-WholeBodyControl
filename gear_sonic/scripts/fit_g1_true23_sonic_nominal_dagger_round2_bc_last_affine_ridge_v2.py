"""Fit versioned round2 final-affine SONIC student after the strict v1 gate rejection."""
...
from gear_sonic.utils.g1_true23_sonic_nominal_dagger_round2_bc_last_affine_ridge_v2 import (
    preflight,
    run_fit,
)
...
DEFAULT_OUTPUT = Path("artifacts/g1_true23/sonic_nominal_dagger_round2_bc_last_affine_ridge_v2")
        ...
        json.dumps(
            {
                ...
                "cutoff140_all_ratio": (
                    body["metrics"]["cutoff140"]["candidate"]["rmse"]
                    / body["metrics"]["cutoff140"]["base"]["rmse"]
                ),
                "cutoff140_shadow_ratio": (
                    body["metrics"]["cutoff140_shadow"]["candidate"]["rmse"]
                    / body["metrics"]["cutoff140_shadow"]["base"]["rmse"]
                ),
            },
            indent=2,
            sort_keys=True,
