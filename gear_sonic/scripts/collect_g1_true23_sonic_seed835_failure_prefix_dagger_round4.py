#!/usr/bin/env python3
"""Collect round4 seed835 pure-student failure-prefix DAgger rows."""
...
from gear_sonic.utils import g1_true23_sonic_nominal_dagger_cutoff50_collection as collection_base
from gear_sonic.utils.g1_true23_sonic_seed835_failure_prefix_dagger_round4 import collect, preflight, publish
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    request = collection_base.CollectionRequest(args.repository_root, args.output_prefix)
    ...
    print(json.dumps({"npz": str(npz), "manifest": str(manifest), "rows": body["rows"]}, indent=2))
    return 0
