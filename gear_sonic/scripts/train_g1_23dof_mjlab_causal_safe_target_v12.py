"""Run stronger 100-update true23 causal safe-target fine-tuning v12."""
...
from gear_sonic.scripts import (
    train_g1_23dof_mjlab_causal_disturbance_v10 as v10,
...
DEFAULT_RUN = Path("/root/g1_true23_runs/causal_safe_target_v12")
...
def causal_safe_target_v12_training_contract() -> dict[str, object]:
    return {
        "schema": "g1_true23_causal_safe_target_training_v12",
        ...
        "v11_transform_and_recovery_task_unchanged": True,
...
def _install_isolated_v12_hooks() -> None:
    v10._install_isolated_v10_hooks()
    ...
    def resolved_with_v12(*args: Any, **kwargs: Any) -> dict[str, Any]:
        ...
        if not isinstance(motion_path, Path) or not isinstance(num_envs, int):
            raise ValueError("v12 resolved config requires motion path and env count")
        ...
        resolved["causal_safe_target_training_v12"] = (
            causal_safe_target_v12_training_contract()
        )
        return resolved

    base._resolved_training_config = resolved_with_v12
...
def preflight(args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        **report,
        "schema": "g1_true23_causal_safe_target_preflight_v12",
        ...
        "causal_safe_target_training_v12": (
            causal_safe_target_v12_training_contract()
        ),
    }
