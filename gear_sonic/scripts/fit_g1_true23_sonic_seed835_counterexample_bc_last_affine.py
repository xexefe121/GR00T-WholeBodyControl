"""Fit final-affine SONIC student on seed835 counterexample DAgger rows."""
...
from gear_sonic.utils.g1_true23_sonic_seed835_counterexample_bc_last_affine import preflight, run_fit

DEFAULT_OUTPUT = Path("artifacts/g1_true23/sonic_seed835_counterexample_bc_last_affine_v1")
        ...
        json.dumps(
            {
                ...
                "counterexample_base_rmse": body["metrics"]["counterexample"]["base"]["rmse"],
                "counterexample_candidate_rmse": body["metrics"]["counterexample"]["candidate"]["rmse"],
            },
            indent=2,
            sort_keys=True,
        )
