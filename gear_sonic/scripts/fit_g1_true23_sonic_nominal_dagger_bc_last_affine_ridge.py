"""Fit final-affine SONIC student on nominal plus cutoff50 intervention data."""
...
from gear_sonic.utils.g1_true23_sonic_nominal_dagger_bc_last_affine_ridge import (
    preflight,
    run_fit,
)
...
DEFAULT_OUTPUT = Path("artifacts/g1_true23/sonic_nominal_dagger_bc_last_affine_ridge_v1")
        ...
        json.dumps(
            {
                ...
                "student_shadow_base_rmse": body["metrics"]["student_shadow_base"]["rmse"],
                "student_shadow_candidate_rmse": body["metrics"]["student_shadow_candidate"]["rmse"],
            },
            indent=2,
            sort_keys=True,
        )
