"""Fit final-affine SONIC student on round3 seed835 counterexample rows."""
...
from gear_sonic.utils.g1_true23_sonic_seed835_counterexample_round3_bc_last_affine import preflight, run_fit

DEFAULT_OUTPUT = Path("artifacts/g1_true23/sonic_seed835_counterexample_round3_bc_last_affine_v1")
        ...
        json.dumps(
            {
                ...
                "round3_base_rmse": body["metrics"]["round3_counterexample"]["base"]["rmse"],
                "round3_candidate_rmse": body["metrics"]["round3_counterexample"]["candidate"]["rmse"],
            },
            indent=2,
            sort_keys=True,
        )
