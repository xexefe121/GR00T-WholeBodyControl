"""Qualify the nominal multi-seed SONIC student in one exact 510-step episode."""
...
from gear_sonic.utils.g1_true23_sonic_nominal_multiseed_student_qualification import (
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    report = run_nominal_multiseed_student_qualification(
