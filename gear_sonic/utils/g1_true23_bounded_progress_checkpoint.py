...
from gear_sonic.trl.mjlab.native23_bounded_progress_runner import decoder_schema_view, validate_checkpoint
...
def load_cpu_actor(checkpoint_path, *, warm_start_path, source_checkpoint_path):
    ...
    identity = {
        "kind": "native23_bounded_progress_pytorch_cpu_research_reader_v1",
