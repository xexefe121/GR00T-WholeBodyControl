...
CHECKPOINT_HEADER = {
    "schema_version": 1,
    "kind": "g1_native23_pose_lora_original_intent_training_snapshot",
    "role": "simulator_research_fresh_run_snapshot_only",
    "deployment_ready": False,
    "promotion_eligible": False,
    "hardware_authorized": False,
}
PROFILE = "pose_lora_root_priority_v1"
MULTIPLIERS = {"root_conditioner": 200.0, "pose_adapter": 200.0, "exploration": 1.0, "critic": 600.0}
...
def validate_pose_lora_checkpoint(value, *, actor, lineage, minimum_update_count=0):
    ...
    if resolved.get("native23_pose_lora") != training_contract():
...
class Native23PoseLoraRunner(Native23GeneralistRunner):
    ...
    def _validate_initial_policy(self):
        ...
        if not isinstance(actor, True23PoseLoraActorModel) or not actor.initial_conditioner_is_zero():
    ...
    def _numbered_checkpoint_path(self, update_count):
        ...
        return self.checkpoint_dir / f"pose_lora_model_{count}.pt"
    ...
    def save(self, path, infos=None):
        ...
        try:
            ...
            validate_pose_lora_checkpoint(loaded, actor=self.alg.get_policy(), lineage=self._training_lineage)
