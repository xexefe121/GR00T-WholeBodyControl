"""Fresh-only decoder-LoRA SIM snapshots with an explicit new reward header."""
...
CHECKPOINT_HEADER = {
    **DECODER_HEADER,
    "kind": "g1_native23_decoder_lora_bounded_progress_training_snapshot",
}
...
class Native23BoundedProgressRunner(Native23DecoderLoraRunner):
    ...
    def _numbered_checkpoint_path(self, update_count):
        ...
        return old.with_name(old.name.replace("decoder_lora_model_", "bounded_progress_model_"))
